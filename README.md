1. Главная страница приложения +40/40
  - вёрстка, дизайн, UI главной страницы приложения главная страница приложения содержит:
...
5. Мини-игры "Аудиовызов" и "Спринт" +200/200 (100 баллов за игру)
...
9. Дополнительный функционал +80/80
