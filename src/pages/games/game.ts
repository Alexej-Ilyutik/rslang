   ...
   <section class="light">
	<div class="container py-2">
		<article class="postcard light blue">
			<a class="postcard__img_link" href="#/sprint">
				<img class="postcard__img" src="../../assets/sprint.png" alt="sprint" />
			</a>
			<div class="postcard__text t-dark">
				<h2 class="postcard__title blue"><a href="#/sprint">Sprint</a></h2>
        ...
        making educated guesses about what is right and what is wrong.</div>
				<a href="#/sprint" class="game__btn btn btn-warning" role="button">Play game</a>
			</div>
		</article>
		<article class="postcard light red">
			<a class="postcard__img_link" href="#/audio">
				<img class="postcard__img" src="../../assets/audio-img.png" alt="audio" alt="Image Title" />
			</a>
			<div class="postcard__text t-dark">
				<h2 class="postcard__title red"><a href="#/audio">Audio challenge</a></h2>
				<div class="postcard__bar"></div>
		...
		<article class="postcard light green">
			...
			<div class="postcard__text t-dark">
				<h2 class="postcard__title green"><a href="#">Other games</a></h2>
				<div class="postcard__bar"></div>
		...
		<article class="postcard light yellow">
			...
			<div class="postcard__text t-dark">
				<h2 class="postcard__title yellow"><a href="#">Other games</a></h2>
