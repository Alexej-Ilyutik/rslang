   ...
   <section class="light">
	<div class="container py-2">
		...
		<article class="postcard light green">
			<a class="postcard__img_link link-direction" href="#">
				<img class="postcard__img" src="../../assets/london.jpg" alt="Image Title" />
			</a>
			<div class="postcard__text t-dark">
				<h2 class="postcard__title green"><a class = "link-direction" href="#">Other games</a></h2>
				<div class="postcard__bar"></div>
		...
		<article class="postcard light yellow">
			...
			<div class="postcard__text t-dark">
				<h2 class="postcard__title yellow"><a class = "link-direction" href="#">Other games</a></h2>
