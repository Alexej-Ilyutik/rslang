        ...
        <div class="modal-body">
          <form id="register-form" autocomplete="off">
            <div class="form-floating mb-3">
              <input type="text" class="form-control" id="register-name-input" required="required" placeholder="Name" pattern=".{2,}" required title="2 characters minimum">
              <label for="register-name-input">Name</label>
            </div>
            <div class="form-floating mb-3">
              <input type="email" class="form-control" id="register-email-input" required="required" placeholder="name@example.com">
              <label for="register-email-input">Email address</label>
            </div>
            <div class="form-floating mb-2">
              <input type="password" class="form-control" id="register-password-input" required="required" placeholder="Password" pattern=".{8,}"   required title="8 characters minimum">
